...
```{r}
dat <- subset(datos,(Componente4kW/Num_productos) < 2500)
...
b = dat$Componente1kW+dat$Componente2kW+dat$Componente3kW+dat$Componente4kW
for(i in vars){
    a = (dat[[i]]/dat$Num_productos)
