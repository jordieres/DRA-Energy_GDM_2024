...
```
```{r}
variables <- c("Componente1kW/Num_productos","Componente2kW/Num_productos", "Componente3kW/Num_productos", "Componente4kW/Num_productos","Componente7kW/Num_productos")
umbrales <- c(800, 800, 1000, 1000,2000)
...
```{r}
dat <- subset(datos, (Componente1kW/Num_productos) < 800 & (Componente2kW/Num_productos) < 800 & (Componente3kW/Num_productos) < 1000 & (Componente4kW/Num_productos) < 1000 & (Componente7kW/Num_productos) < 1000 & Recocido == 'Continuous Annealing')
...
corrplot(cor(dat[,c(4,5,7:16,27:33)]), method = 'ellipse')
