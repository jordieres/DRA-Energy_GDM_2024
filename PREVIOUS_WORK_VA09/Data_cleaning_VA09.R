...
datos = read_excel("linea_VA09.guay.xlsx")
...
resultado2 <- datos2 %>%
  ...
  summarise(parametroA = `Production-Order Parameter A`,
            ...
            Componente7kW= sum(Component7, na.rm = TRUE),
...
VA09_final = "VA09_final.xlsx"

write.xlsx(res_unique, file = VA09_final, rowNames = FALSE)
