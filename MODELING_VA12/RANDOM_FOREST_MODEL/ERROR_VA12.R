validar_valor <- function(parametro, valor) {
  ...
  if (parametro == "Ancho_mm" && (valor_numerico < 650 || valor_numerico > 1300)) {
    cat("Error: El valor de Ancho_mm debe estar entre 650 y 1300\n")
    return(FALSE)
  }
  ...
  if (parametro == "parametroA" && (valor_numerico < 100 || valor_numerico > 430)) {
    cat("Error: El valor de parametroA debe estar entre 100 y 430\n")
    return(FALSE)
  }
  if (parametro == "parametroB" && (valor_numerico < 1 || valor_numerico > 55)) {
    cat("Error: El valor de parametroB debe estar entre 1 y 55\n")
    return(FALSE)
  }
  if (parametro == "parametroC" && (valor_numerico < 10 || valor_numerico > 81)) {
    cat("Error: El valor de parametroC debe estar entre 10 y 81\n")
    return(FALSE)
  }
  ...
  if (parametro == "parametroF" && (valor_numerico < 25 || valor_numerico > 54)) {
    cat("Error: El valor de parametroF debe estar entre 25 y 54\n")
    return(FALSE)
  }
  if (parametro == "parametroG" && (valor_numerico < 1 || valor_numerico > 2)) {
    cat("Error: El valor de parametroG debe estar entre 1 y 2\n")
    return(FALSE)
  }
  ...
  if (parametro == "parametroI" && (valor_numerico < 102 || valor_numerico > 382)) {
